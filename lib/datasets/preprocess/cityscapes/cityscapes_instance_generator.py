...
# python lib/datasets/preprocess/cityscapes/cityscapes_instance_generator.py --coarse True --save_dir ../../input/cityscapes_conseg/cityscapes --ori_root_dir ../../input/cityscapes
